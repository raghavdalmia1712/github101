...
class Game(tk.Canvas):
    ...
    def __init__(self,root):
        ...
        self.bar = self.create_rectangle(0, 0, 0, 0, width=0, state="hidden")
    ...
    def reset(self):
        ...
        self.coords(self.ball, ((self.screenWidth - self.barWidth)/2, self.screenHeight - self.barHeight, (self.screenWidth + self.barWidth)/2, self.screenHeight))
    ...
    def moveBall(self):
        ...
        # Collision computation between ball and bricks
        i=0
        while i < len(self.bricks):
            ...
            if not collisionNext:
                ...
                # "ballTall" effect (turqouise effect)
                ...
                # If the brick is orange, it becomed yellow.
                elif brickColor == self.bricksColors["o"]:
                    self.itemconfig(self.bricksColors[i], fill=self.bricksColors["y"])
                # If the brick is yellow (or any other color except red/orang), it is destroyed.
                else:
